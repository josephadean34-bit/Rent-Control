...
___ contains the R code necessary to achieve steps 1,2, and 3

The project utilized a two way fixed effects model and found that rent control apartments properties were associated with about 10-13% lower rents compared to none rent control apartments.
